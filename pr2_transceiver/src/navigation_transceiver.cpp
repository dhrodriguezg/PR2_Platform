...
void NavigationTransceiver::init() {
    ...
    robot_target_x= 2.8205;
    robot_target_y=-3.57335;
...
void NavigationTransceiver::publishMsgs(){
    ...
    //head
    float ref_head_ry = head_ry + 1.570796327;
    if(interface_number==INTERFACE01 || interface_number==INTERFACE02){
    ...
    if(user_interface>0.f){
        ...
        std::string name(folder + "/scenarioA_interface_" + boost::to_string(user_interface) + ".txt");
